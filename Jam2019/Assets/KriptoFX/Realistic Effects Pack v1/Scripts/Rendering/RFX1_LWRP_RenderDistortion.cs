...
public class RFX1_LWRP_RenderDistortion: MonoBehaviour, IAfterTransparentPass
{
    public bool IsActive = true;
    private RFX1_CustomDistortionImpl customustomDistortionImpl;
    ...
    {
        if (customustomDistortionImpl == null) customustomDistortionImpl = new RFX1_CustomDistortionImpl();
...
public class RFX1_CustomDistortionImpl : ScriptableRenderPass
{
    public bool IsActive = true;
    ...
    public RFX1_CustomDistortionImpl()
    {
